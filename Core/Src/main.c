...
//		    }
		max30102_read(&max30102, 0x07, en_reg, 2);
		sprintf((char*)buffer, "FIFO_DATA_REG=%d,%d\n",en_reg[0],en_reg[1]);
		HAL_UART_Transmit(&huart2,buffer,strlen(buffer),HAL_MAX_DELAY);
		HAL_Delay(5000);
